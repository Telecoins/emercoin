...
unlocked to sign the Telechain-Qt.app bundle.
...
allowing somebody to distribute a Telechain-Qt.app or telechain-qt-setup.exe with a valid
...
that the telechain-qt.exe file inside the installer had not been tampered with.
