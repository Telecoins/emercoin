...
CBlockHeaderAndShortTxIDs::CBlockHeaderAndShortTxIDs(const CBlock& block, bool fUseWTXID) :
    ...
    // telechain: get header with correct nFlags and auxpow
    BlockMap::iterator mi = mapBlockIndex.find(block.GetHash());
    assert(mi != mapBlockIndex.end()); // telechain: we should always have index for a block that we have accepted
