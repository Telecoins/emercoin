...
public:
    ...
    int32_t nVersion;     // telechain: it might contain merged mining information in higher bits. Use GetBlockVersion() to ignore it.
    ...
    // telechain: copy from CBlockIndex.nFlags from other clients. We need this information because we are using headers-first syncronization.
    int32_t nFlags;
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // telechain: do not serialize these fields when computing hash
