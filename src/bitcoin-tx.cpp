...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s telechain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  telechain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded telechain transaction") + "\n" +
              "  telechain-tx [options] -create [commands]   " + _("Create hex-encoded telechain transaction") + "\n" +
              "\n";
