...
#ifndef TELECHAIN_SERIALIZE_H
#define TELECHAIN_SERIALIZE_H
...
enum
{
    ...
    // modifiers
    SER_POSMARKER       = (1 << 18),  // telechain: for sending block headers with PoS marker, to allow headers-first syncronization
    SER_BTC_TX          = (1 << 19),  // telechain: for merged mining, to read tx without nTime.
};
