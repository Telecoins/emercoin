...
#ifndef TELECHAIN_BITCOINCONSENSUS_H
#define TELECHAIN_BITCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_TELECHAIN_INTERNAL) && defined(HAVE_CONFIG_H)
...
#endif // TELECHAIN_BITCOINCONSENSUS_H
