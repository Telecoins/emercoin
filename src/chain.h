...
#ifndef TELECHAIN_CHAIN_H
#define TELECHAIN_CHAIN_H
...
public:
    ...
    //! block header
    int nVersion;     // telechain: it might contain merged mining information in higher bits. Use GetBlockVersion() to ignore it.
