...
- #8492 `8b0bdd3` Allow building bench_telechain by itself (luke-jr)
...
- #8829 `2a8bca4` Add telechain-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_telechainds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name telechain.qrc  (bitcoinsSG)
...
- #8817 `bcf3806` update telechain-tx to output witness data (jnewbery)
