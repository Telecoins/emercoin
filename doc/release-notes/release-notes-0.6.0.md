...
in your terminal, then install the telechain-qt package.
...
Telechain-Qt can display and save QR codes for sending
...
versions of Telechain-Qt/telechaind.
...
Telechain-Qt's initial splash screen
...
opening/launching Telechain-Qt is available only on Linux,
and only if you configure your desktop to launch
Telechain-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Telechain-Qt window to start
payment.
...
It is expected that future releases of Telechain-Qt
