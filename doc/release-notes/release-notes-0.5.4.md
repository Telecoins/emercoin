...
http://gitorious.org/bitcoin/telechaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Telechain-Qt notifications under Growl 1.3.
Increase required age of Telechain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Telechain-Qt over it. (Windows)
