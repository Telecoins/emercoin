Telechain-Qt version 0.8.2 is now available from:
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Telechain-Qt debug
console will cause Telechain-Qt to crash. Run Telechain-Qt with the -server command-line
